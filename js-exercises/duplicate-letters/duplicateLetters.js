function duplicateLetters(...args) {
  ...
  /* counting frequency of each letter
     if the letter is there in the frequency counter - increment the value by 1
     if not - add it in the counter with value = 1
  */
  ...
  /* finding max and second maximum repeated letter
     if the value of the frequency is greater than current max - 
     max equals greater value and second max equals the last max
   */
